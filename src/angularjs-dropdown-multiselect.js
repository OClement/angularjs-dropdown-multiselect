    ...
    function ($filter, $document, $compile, $parse) {
        ...
        return {
            ...
            template: function (element, attrs) {
                ...
                template += '<li ng-hide="!settings.showCheckAll || settings.selectionLimit > 0"><a data-ng-click="selectAll()"><span ng-class="settings.checkmarkIconClasses"></span>  {{texts.checkAll}}</a>';
                template += '<li ng-show="settings.showUncheckAll"><a data-ng-click="deselectAll();"><span ng-class="settings.removeIconClasses"></span>   {{texts.uncheckAll}}</a></li>';
            ...
            link: function ($scope, $element, $attrs) {
                ...
                $scope.settings = {
                    ...
                    checkmarkIconClasses: 'glyphicon glyphicon-ok',
                    removeIconClasses: 'glyphicon glyphicon-remove',
